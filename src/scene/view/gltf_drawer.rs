...
*/
use super::wgpu;
use crate::utils::{create_buffer_with_data, obj_loader::*, texture::Texture};
...
impl GltfDrawer {
    pub fn new(
        ...
        let fragment_module =
            device.create_shader_module(&wgpu::include_spirv!("gltf_obj.frag.spv"));
        let format = crate::TEXTURE_FORMAT;
        let blend_state = wgpu::BlendState::ALPHA_BLENDING;
        let sample_count = crate::consts::SAMPLE_COUNT;
        ...
        let primitive_topology = wgpu::PrimitiveTopology::TriangleStrip; // Is this correct ??
