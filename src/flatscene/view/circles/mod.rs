use std::rc::Rc;
use iced_wgpu::wgpu;
use wgpu::{BindGroupLayout, Device, RenderPipeline, RenderPass, Queue, include_spirv};
use ultraviolet::Vec2;

use crate::utils::bindgroup_manager::{UniformBindGroup, DynamicBindGroup};
...
impl CircleDrawer {
    ...
    pub fn draw<'a>(&'a mut self, render_pass: &mut RenderPass<'a>) {
        ...
        render_pass.set_bind_group(
            1,
            self.instances_bg.get_bindgroup(),
            &[],
        );
    ...
    fn create_pipeline(&self, globals_layout: &BindGroupLayout) -> RenderPipeline {
        let vertex_module = self.device.create_shader_module(include_spirv!("circle.vert.spv"));
        let fragment_module = self.device.create_shader_module(include_spirv!("circle.frag.spv"));
        ...
        self.device.create_render_pipeline(&wgpu::RenderPipelineDescriptor {
            ...
            vertex_state: wgpu::VertexStateDescriptor {
                ...
                vertex_buffers: &[textures::Vertex::desc()],
            },
